...
<tr class="h-18 border-b border-coolGray-100">
    ...
    <div class="flex items-center -m-2">
        <div class="w-auto p-2">
            <p class="text-xs font-semibold text-coolGray-500">#NAMAPARTNER#</p>
            <p class="text-xs font-semibold text-coolGray-500">#NPMPARTNER#</p>
            <p class="text-xs font-semibold text-coolGray-500">#KELASPARTNER#</p>
        </div>
    </div>
    </th>
    ...
    |
    <a type="button" href="edit_Proyek.html?proyekId=#IDEDIT#"> Edit
    </a>
    |
...
<tr class="h-18 border-b border-coolGray-100">
    ...
    <th class="whitespace-nowrap px-4 bg-white text-center">
    <div class="w-auto p-2">
        <p class="text-xs font-semibold text-coolGray-800">#PRODI#</p>
    </div>
    </th>
    <th class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800">
    ...
    |
    <button type="button" id="del_button" onclick="deleteDataMahasiswa('#IDHAPUS#')"> Delete
    </button>
    </th>
    <th class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800">
        <svg class="ml-auto" width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<tr class="h-18 border-b border-coolGray-100">
    ...
    |
    <button type="button" id="del_button" onclick="deleteDataDosen('#IDHAPUS#')"> Delete
    </button>
    </th>
    <th class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800">
        <svg class="ml-auto" width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
